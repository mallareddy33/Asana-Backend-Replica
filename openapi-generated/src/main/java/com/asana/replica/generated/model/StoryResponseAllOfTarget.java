...
@JsonTypeName("StoryResponse_allOf_target")
...
public class StoryResponseAllOfTarget {
  ...
  public StoryResponseAllOfTarget gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public StoryResponseAllOfTarget resourceType(@Nullable String resourceType) {
  ...
  public StoryResponseAllOfTarget name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public StoryResponseAllOfTarget resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public StoryResponseAllOfTarget createdBy(@Nullable TaskCompactCreatedBy createdBy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, storyResponseAllOfTarget.gid) &&
        ...
        Objects.equals(this.createdBy, storyResponseAllOfTarget.createdBy);
  }
