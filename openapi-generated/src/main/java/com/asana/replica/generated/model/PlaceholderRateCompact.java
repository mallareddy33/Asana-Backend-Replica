...
public class PlaceholderRateCompact {
  ...
  public PlaceholderRateCompact gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public PlaceholderRateCompact resourceType(@Nullable String resourceType) {
  ...
  public PlaceholderRateCompact parent(@Nullable ProjectCompact parent) {
    this.parent = parent;
    return this;
  }
  ...
  public PlaceholderRateCompact resource(@Nullable PlaceholderCompact resource) {
  ...
  public PlaceholderRateCompact rate(@Nullable BigDecimal rate) {
    this.rate = rate;
    return this;
  }
  ...
  public PlaceholderRateCompact currencyCode(@Nullable String currencyCode) {
  ...
  public PlaceholderRateCompact createdBy(@Nullable UserCompact createdBy) {
  ...
  public boolean equals(Object o) {
    ...
    PlaceholderRateCompact placeholderRateCompact = (PlaceholderRateCompact) o;
    return Objects.equals(this.gid, placeholderRateCompact.gid) &&
        Objects.equals(this.resourceType, placeholderRateCompact.resourceType) &&
        Objects.equals(this.parent, placeholderRateCompact.parent) &&
        Objects.equals(this.resource, placeholderRateCompact.resource) &&
        Objects.equals(this.rate, placeholderRateCompact.rate) &&
        Objects.equals(this.currencyCode, placeholderRateCompact.currencyCode) &&
        Objects.equals(this.createdBy, placeholderRateCompact.createdBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlaceholderRateCompact {\n");
