...
@Schema(name = "TaskCompact", description = "The *task* is the basic object around which many operations in Asana are centered.")
...
public class TaskCompact {
  ...
  public TaskCompact gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public TaskCompact resourceType(@Nullable String resourceType) {
  ...
  public TaskCompact name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TaskCompact resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public TaskCompact createdBy(@Nullable TaskCompactCreatedBy createdBy) {
