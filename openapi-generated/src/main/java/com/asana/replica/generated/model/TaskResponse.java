...
import com.asana.replica.generated.model.CustomFieldResponse;
import com.asana.replica.generated.model.CustomTypeCompact;
import com.asana.replica.generated.model.CustomTypeStatusOptionCompact;
...
import com.asana.replica.generated.model.TaskResponseAllOfAssigneeSection;
import com.asana.replica.generated.model.TaskResponseAllOfParent;
import com.asana.replica.generated.model.TaskResponseAllOfWorkspace;
...
public class TaskResponse {
  ...
  private JsonNullable<UserCompact> assignee = JsonNullable.<UserCompact>undefined();

  private @Nullable TaskResponseAllOfAssigneeSection assigneeSection;

  @Valid
  private List<CustomFieldResponse> customFields = new ArrayList<>();

  private JsonNullable<CustomTypeCompact> customType = JsonNullable.<CustomTypeCompact>undefined();

  private JsonNullable<CustomTypeStatusOptionCompact> customTypeStatusOption = JsonNullable.<CustomTypeStatusOptionCompact>undefined();

  @Valid
  private List<@Valid UserCompact> followers = new ArrayList<>();

  private @Nullable TaskResponseAllOfParent parent;

  @Valid
  private List<@Valid ProjectCompact> projects = new ArrayList<>();

  @Valid
  private List<@Valid TagCompact> tags = new ArrayList<>();

  private @Nullable TaskResponseAllOfWorkspace workspace;

  private @Nullable String permalinkUrl;

  public TaskResponse gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public TaskResponse resourceType(@Nullable String resourceType) {
  ...
  public TaskResponse resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public TaskResponse createdBy(@Nullable TaskCompactCreatedBy createdBy) {
  ...
  public TaskResponse approvalStatus(@Nullable ApprovalStatusEnum approvalStatus) {
  ...
  public TaskResponse assigneeStatus(@Nullable AssigneeStatusEnum assigneeStatus) {
  ...
  public TaskResponse completed(@Nullable Boolean completed) {
  ...
  public TaskResponse createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public TaskResponse external(@Nullable TaskBaseAllOfExternal external) {
  ...
  public TaskResponse htmlNotes(@Nullable String htmlNotes) {
  ...
  public TaskResponse hearted(@Nullable Boolean hearted) {
  ...
  public TaskResponse isRenderedAsSeparator(@Nullable Boolean isRenderedAsSeparator) {
  ...
  public TaskResponse liked(@Nullable Boolean liked) {
    this.liked = liked;
    return this;
  }
  ...
  public TaskResponse modifiedAt(@Nullable OffsetDateTime modifiedAt) {
  ...
  public TaskResponse notes(@Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public TaskResponse numHearts(@Nullable Integer numHearts) {
  ...
  public TaskResponse numLikes(@Nullable Integer numLikes) {
  ...
  public TaskResponse numSubtasks(@Nullable Integer numSubtasks) {
  ...
  public JsonNullable<UserCompact> getAssignee() {
    return assignee;
  }

  public void setAssignee(JsonNullable<UserCompact> assignee) {
    this.assignee = assignee;
  }

  public TaskResponse assigneeSection(@Nullable TaskResponseAllOfAssigneeSection assigneeSection) {
  ...
  public @Nullable TaskResponseAllOfAssigneeSection getAssigneeSection() {
    return assigneeSection;
  }

  public void setAssigneeSection(@Nullable TaskResponseAllOfAssigneeSection assigneeSection) {
    this.assigneeSection = assigneeSection;
  }

  public TaskResponse customFields(List<CustomFieldResponse> customFields) {
  ...
  public TaskResponse customType(CustomTypeCompact customType) {
   ...
   */
  @Valid 
  @Schema(name = "custom_type", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("custom_type")
  public JsonNullable<CustomTypeCompact> getCustomType() {
    return customType;
  }

  public void setCustomType(JsonNullable<CustomTypeCompact> customType) {
    this.customType = customType;
  }

  public TaskResponse customTypeStatusOption(CustomTypeStatusOptionCompact customTypeStatusOption) {
    this.customTypeStatusOption = JsonNullable.of(customTypeStatusOption);
    return this;
  }

  /**
   * Get customTypeStatusOption
   * @return customTypeStatusOption
   */
  @Valid 
  @Schema(name = "custom_type_status_option", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("custom_type_status_option")
  public JsonNullable<CustomTypeStatusOptionCompact> getCustomTypeStatusOption() {
    return customTypeStatusOption;
  }

  public void setCustomTypeStatusOption(JsonNullable<CustomTypeStatusOptionCompact> customTypeStatusOption) {
  ...
  public TaskResponse parent(@Nullable TaskResponseAllOfParent parent) {
    this.parent = parent;
    return this;
  }
  ...
  @JsonProperty("parent")
  public @Nullable TaskResponseAllOfParent getParent() {
    return parent;
  }

  public void setParent(@Nullable TaskResponseAllOfParent parent) {
    this.parent = parent;
  }
  ...
  public TaskResponse workspace(@Nullable TaskResponseAllOfWorkspace workspace) {
  ...
  public @Nullable TaskResponseAllOfWorkspace getWorkspace() {
    return workspace;
  }

  public void setWorkspace(@Nullable TaskResponseAllOfWorkspace workspace) {
    this.workspace = workspace;
  }

  public TaskResponse permalinkUrl(@Nullable String permalinkUrl) {
  ...
  @Schema(name = "permalink_url", accessMode = Schema.AccessMode.READ_ONLY, example = "https://app.asana.com/1/12345/task/123456789", description = "A url that points directly to the object within Asana.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, taskResponse.gid) &&
        ...
        equalsNullable(this.completedBy, taskResponse.completedBy) &&
        ...
        equalsNullable(this.customType, taskResponse.customType) &&
        equalsNullable(this.customTypeStatusOption, taskResponse.customTypeStatusOption) &&
