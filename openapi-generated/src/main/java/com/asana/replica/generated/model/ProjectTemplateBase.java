...
public class ProjectTemplateBase {
  ...
  public ProjectTemplateBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectTemplateBase resourceType(@Nullable String resourceType) {
  ...
  public ProjectTemplateBase name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectTemplateBase description(@Nullable String description) {
  ...
  public ProjectTemplateBase htmlDescription(@Nullable String htmlDescription) {
  ...
  public ProjectTemplateBase _public(@Nullable Boolean _public) {
  ...
  public ProjectTemplateBase owner(@Nullable ProjectTemplateBaseAllOfOwner owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ProjectTemplateBase team(@Nullable TeamCompact team) {
    this.team = team;
    return this;
  }
  ...
  public ProjectTemplateBase requestedDates(List<@Valid DateVariableCompact> requestedDates) {
    this.requestedDates = requestedDates;
    return this;
  }

  public ProjectTemplateBase addRequestedDatesItem(DateVariableCompact requestedDatesItem) {
  ...
  public ProjectTemplateBase requestedRoles(List<@Valid TemplateRole> requestedRoles) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, projectTemplateBase.gid) &&
        ...
        equalsNullable(this.color, projectTemplateBase.color) &&
