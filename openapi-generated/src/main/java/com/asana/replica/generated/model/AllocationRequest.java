...
public class AllocationRequest {
  ...
  public AllocationRequest gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public AllocationRequest resourceType(@Nullable String resourceType) {
  ...
  public AllocationRequest startDate(@Nullable LocalDate startDate) {
  ...
  public AllocationRequest endDate(@Nullable LocalDate endDate) {
  ...
  public AllocationRequest effort(AllocationBaseEffort effort) {
  ...
  public AllocationRequest assignee(@Nullable String assignee) {
  ...
  @Schema(name = "assignee", description = "Globally unique identifier for the user or placeholder assigned to the allocation.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public AllocationRequest parent(@Nullable String parent) {
    this.parent = parent;
    return this;
  }
  ...
  @Schema(name = "parent", description = "Globally unique identifier for the project the allocation is on.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("parent")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, allocationRequest.gid) &&
        Objects.equals(this.resourceType, allocationRequest.resourceType) &&
        Objects.equals(this.startDate, allocationRequest.startDate) &&
        Objects.equals(this.endDate, allocationRequest.endDate) &&
        equalsNullable(this.effort, allocationRequest.effort) &&
        Objects.equals(this.assignee, allocationRequest.assignee) &&
        Objects.equals(this.parent, allocationRequest.parent);
  }
