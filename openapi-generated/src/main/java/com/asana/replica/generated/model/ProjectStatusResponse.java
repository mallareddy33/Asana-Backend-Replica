...
public class ProjectStatusResponse {
  ...
  public ProjectStatusResponse gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectStatusResponse resourceType(@Nullable String resourceType) {
  ...
  public ProjectStatusResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProjectStatusResponse text(@Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public ProjectStatusResponse htmlText(@Nullable String htmlText) {
  ...
  public ProjectStatusResponse color(@Nullable ColorEnum color) {
    this.color = color;
    return this;
  }
  ...
  public ProjectStatusResponse author(@Nullable UserCompact author) {
    this.author = author;
    return this;
  }
  ...
  public ProjectStatusResponse createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public ProjectStatusResponse createdBy(@Nullable UserCompact createdBy) {
  ...
  public ProjectStatusResponse modifiedAt(@Nullable OffsetDateTime modifiedAt) {
