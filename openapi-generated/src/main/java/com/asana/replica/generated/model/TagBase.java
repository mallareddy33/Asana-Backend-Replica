...
public class TagBase {
  ...
  public TagBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public TagBase resourceType(@Nullable String resourceType) {
  ...
  public TagBase name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TagBase notes(@Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, tagBase.gid) &&
        ...
        equalsNullable(this.color, tagBase.color) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, hashCodeNullable(color), notes);
  }
