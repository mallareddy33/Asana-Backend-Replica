...
@Schema(name = "PortfolioMembershipCompact", description = "This object determines if a user is a member of a portfolio.")
...
public class PortfolioMembershipCompact {
  ...
  public PortfolioMembershipCompact gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public PortfolioMembershipCompact resourceType(@Nullable String resourceType) {
  ...
  public PortfolioMembershipCompact parent(@Nullable PortfolioCompact parent) {
    this.parent = parent;
    return this;
  }
  ...
  public PortfolioMembershipCompact member(@Nullable MemberCompact member) {
    this.member = member;
    return this;
  }
  ...
  public PortfolioMembershipCompact accessLevel(@Nullable AccessLevelEnum accessLevel) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, portfolioMembershipCompact.gid) &&
        ...
        Objects.equals(this.parent, portfolioMembershipCompact.parent) &&
        Objects.equals(this.member, portfolioMembershipCompact.member) &&
        Objects.equals(this.accessLevel, portfolioMembershipCompact.accessLevel);
  }
