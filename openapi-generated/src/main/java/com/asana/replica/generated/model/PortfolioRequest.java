...
public class PortfolioRequest {
  ...
  public PortfolioRequest gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public PortfolioRequest resourceType(@Nullable String resourceType) {
  ...
  public PortfolioRequest name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PortfolioRequest archived(@Nullable Boolean archived) {
  ...
  public PortfolioRequest color(@Nullable ColorEnum color) {
    this.color = color;
    return this;
  }
  ...
  public PortfolioRequest startOn(LocalDate startOn) {
  ...
  public PortfolioRequest dueOn(LocalDate dueOn) {
  ...
  public PortfolioRequest defaultAccessLevel(@Nullable DefaultAccessLevelEnum defaultAccessLevel) {
  ...
  public PortfolioRequest workspace(@Nullable String workspace) {
  ...
  @Schema(name = "workspace", example = "167589", description = "*Create-only*. The workspace or organization that the portfolio belongs to.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public PortfolioRequest _public(@Nullable Boolean _public) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, portfolioRequest.gid) &&
        ...
        Objects.equals(this.archived, portfolioRequest.archived) &&
        Objects.equals(this.color, portfolioRequest.color) &&
        equalsNullable(this.startOn, portfolioRequest.startOn) &&
        equalsNullable(this.dueOn, portfolioRequest.dueOn) &&
        Objects.equals(this.defaultAccessLevel, portfolioRequest.defaultAccessLevel) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, archived, color, hashCodeNullable(startOn), hashCodeNullable(dueOn), defaultAccessLevel, workspace, _public);
  }
