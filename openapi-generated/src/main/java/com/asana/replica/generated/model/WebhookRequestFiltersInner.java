...
@Schema(name = "WebhookRequest_filters_inner", description = "A set of filters to specify a whitelist for what types of events will be delivered.")
...
public class WebhookRequestFiltersInner {
  ...
  public WebhookRequestFiltersInner resourceType(@Nullable String resourceType) {
  ...
  public WebhookRequestFiltersInner resourceSubtype(@Nullable String resourceSubtype) {
  ...
  public WebhookRequestFiltersInner action(@Nullable String action) {
    this.action = action;
    return this;
  }
