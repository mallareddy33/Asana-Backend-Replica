...
import com.asana.replica.generated.model.TagResponse;
...
public class CreateTag201Response {
  ...
  private @Nullable TagResponse data;

  public CreateTag201Response data(@Nullable TagResponse data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable TagResponse getData() {
    return data;
  }

  public void setData(@Nullable TagResponse data) {
    this.data = data;
  }
