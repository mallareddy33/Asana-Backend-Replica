...
public class ProjectMembershipCompactResponse {
  ...
  public ProjectMembershipCompactResponse gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectMembershipCompactResponse resourceType(@Nullable String resourceType) {
  ...
  public ProjectMembershipCompactResponse parent(@Nullable ProjectCompact parent) {
    this.parent = parent;
    return this;
  }
  ...
  public ProjectMembershipCompactResponse member(@Nullable MemberCompact member) {
    this.member = member;
    return this;
  }
  ...
  public ProjectMembershipCompactResponse accessLevel(@Nullable AccessLevelEnum accessLevel) {
  ...
  public ProjectMembershipCompactResponse resourceSubtype(@Nullable String resourceSubtype) {
  ...
  @Schema(name = "resource_subtype", example = "project_membership", description = "Type of the membership.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
