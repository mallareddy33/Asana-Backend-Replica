...
public class ProjectBriefRequest {
  ...
  public ProjectBriefRequest gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectBriefRequest resourceType(@Nullable String resourceType) {
  ...
  public ProjectBriefRequest title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProjectBriefRequest htmlText(@Nullable String htmlText) {
  ...
  public ProjectBriefRequest text(@Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, title, htmlText, text);
  }
