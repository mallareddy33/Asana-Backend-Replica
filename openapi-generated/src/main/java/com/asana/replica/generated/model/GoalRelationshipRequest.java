...
public class GoalRelationshipRequest {
  ...
  public GoalRelationshipRequest gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public GoalRelationshipRequest resourceType(@Nullable String resourceType) {
  ...
  public GoalRelationshipRequest resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public GoalRelationshipRequest supportingResource(@Nullable GoalRelationshipCompactSupportingResource supportingResource) {
  ...
  public GoalRelationshipRequest contributionWeight(@Nullable BigDecimal contributionWeight) {
  ...
  public GoalRelationshipRequest supportedGoal(@Nullable GoalRelationshipBaseAllOfSupportedGoal supportedGoal) {
