...
@Schema(name = "WorkspaceAddUserRequest", description = "A user identification object for specification with the addUser/removeUser endpoints.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.17.0")
public class WorkspaceAddUserRequest {

  private @Nullable String user;

  public WorkspaceAddUserRequest user(@Nullable String user) {
    this.user = user;
    return this;
  }
