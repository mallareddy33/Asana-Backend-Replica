...
public class GetTags200Response {
  ...
  @Valid
  private List<@Valid TagCompact> data = new ArrayList<>();

  private JsonNullable<NextPage> nextPage = JsonNullable.<NextPage>undefined();

  public GetTags200Response data(List<@Valid TagCompact> data) {
    this.data = data;
    return this;
  }

  public GetTags200Response addDataItem(TagCompact dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty("data")
  public List<@Valid TagCompact> getData() {
    return data;
  }

  public void setData(List<@Valid TagCompact> data) {
    this.data = data;
  }

  public GetTags200Response nextPage(NextPage nextPage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getTags200Response.data) &&
        equalsNullable(this.nextPage, getTags200Response.nextPage);
  }
