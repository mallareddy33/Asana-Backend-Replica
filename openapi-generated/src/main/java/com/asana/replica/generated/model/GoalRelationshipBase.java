...
public class GoalRelationshipBase {
  ...
  public GoalRelationshipBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public GoalRelationshipBase resourceType(@Nullable String resourceType) {
  ...
  public GoalRelationshipBase resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public GoalRelationshipBase supportingResource(@Nullable GoalRelationshipCompactSupportingResource supportingResource) {
  ...
  public GoalRelationshipBase contributionWeight(@Nullable BigDecimal contributionWeight) {
  ...
  public GoalRelationshipBase supportedGoal(@Nullable GoalRelationshipBaseAllOfSupportedGoal supportedGoal) {
