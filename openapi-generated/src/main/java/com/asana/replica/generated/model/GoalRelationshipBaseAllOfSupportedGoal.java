...
public class GoalRelationshipBaseAllOfSupportedGoal {
  ...
  public GoalRelationshipBaseAllOfSupportedGoal gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public GoalRelationshipBaseAllOfSupportedGoal resourceType(@Nullable String resourceType) {
  ...
  public GoalRelationshipBaseAllOfSupportedGoal name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GoalRelationshipBaseAllOfSupportedGoal owner(@Nullable GoalCompactOwner owner) {
    this.owner = owner;
    return this;
  }
