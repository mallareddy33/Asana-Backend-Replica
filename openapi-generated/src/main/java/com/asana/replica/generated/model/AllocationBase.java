...
@Schema(name = "AllocationBase", description = "A generic Asana Resource, containing a globally unique identifier.")
...
public class AllocationBase {
  ...
  public AllocationBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public AllocationBase resourceType(@Nullable String resourceType) {
  ...
  public AllocationBase startDate(@Nullable LocalDate startDate) {
  ...
  public AllocationBase endDate(@Nullable LocalDate endDate) {
  ...
  public AllocationBase effort(AllocationBaseEffort effort) {
  ...
  public boolean equals(Object o) {
    ...
    AllocationBase allocationBase = (AllocationBase) o;
    return Objects.equals(this.gid, allocationBase.gid) &&
        Objects.equals(this.resourceType, allocationBase.resourceType) &&
        Objects.equals(this.startDate, allocationBase.startDate) &&
        Objects.equals(this.endDate, allocationBase.endDate) &&
        equalsNullable(this.effort, allocationBase.effort);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, startDate, endDate, hashCodeNullable(effort));
  }
