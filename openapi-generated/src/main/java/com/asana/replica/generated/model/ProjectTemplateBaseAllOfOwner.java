...
public class ProjectTemplateBaseAllOfOwner {
  ...
  public ProjectTemplateBaseAllOfOwner gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectTemplateBaseAllOfOwner resourceType(@Nullable String resourceType) {
  ...
  public ProjectTemplateBaseAllOfOwner name(@Nullable String name) {
    this.name = name;
    return this;
  }
