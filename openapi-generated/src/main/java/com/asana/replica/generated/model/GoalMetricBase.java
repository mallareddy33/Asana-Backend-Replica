...
@Schema(name = "GoalMetricBase", description = "A generic Asana Resource, containing a globally unique identifier.")
...
public class GoalMetricBase {
  ...
  public GoalMetricBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public GoalMetricBase resourceType(@Nullable String resourceType) {
  ...
  public GoalMetricBase resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public GoalMetricBase precision(@Nullable Integer precision) {
  ...
  public GoalMetricBase unit(@Nullable UnitEnum unit) {
    this.unit = unit;
    return this;
  }
  ...
  public GoalMetricBase initialNumberValue(@Nullable BigDecimal initialNumberValue) {
  ...
  public GoalMetricBase targetNumberValue(@Nullable BigDecimal targetNumberValue) {
  ...
  public GoalMetricBase currentNumberValue(@Nullable BigDecimal currentNumberValue) {
  ...
  public GoalMetricBase currentDisplayValue(@Nullable String currentDisplayValue) {
  ...
  public GoalMetricBase progressSource(@Nullable ProgressSourceEnum progressSource) {
  ...
  public GoalMetricBase isCustomWeight(@Nullable Boolean isCustomWeight) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, goalMetricBase.gid) &&
        ...
        Objects.equals(this.isCustomWeight, goalMetricBase.isCustomWeight);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, resourceSubtype, precision, unit, hashCodeNullable(currencyCode), initialNumberValue, targetNumberValue, currentNumberValue, currentDisplayValue, progressSource, isCustomWeight);
  }
