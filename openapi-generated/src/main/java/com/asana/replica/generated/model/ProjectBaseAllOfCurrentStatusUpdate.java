...
@JsonTypeName("ProjectBase_allOf_current_status_update")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.17.0")
public class ProjectBaseAllOfCurrentStatusUpdate {
  ...
  public ProjectBaseAllOfCurrentStatusUpdate gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public ProjectBaseAllOfCurrentStatusUpdate resourceType(@Nullable String resourceType) {
  ...
  public ProjectBaseAllOfCurrentStatusUpdate title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ProjectBaseAllOfCurrentStatusUpdate resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectBaseAllOfCurrentStatusUpdate projectBaseAllOfCurrentStatusUpdate = (ProjectBaseAllOfCurrentStatusUpdate) o;
    return Objects.equals(this.gid, projectBaseAllOfCurrentStatusUpdate.gid) &&
        Objects.equals(this.resourceType, projectBaseAllOfCurrentStatusUpdate.resourceType) &&
        Objects.equals(this.title, projectBaseAllOfCurrentStatusUpdate.title) &&
        Objects.equals(this.resourceSubtype, projectBaseAllOfCurrentStatusUpdate.resourceSubtype);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, title, resourceSubtype);
  }
