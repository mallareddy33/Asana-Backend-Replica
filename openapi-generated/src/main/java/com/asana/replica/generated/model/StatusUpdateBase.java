...
public class StatusUpdateBase {
   ...
   */
  public StatusUpdateBase(String text, StatusTypeEnum statusType) {
    this.text = text;
    this.statusType = statusType;
  }

  public StatusUpdateBase gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public StatusUpdateBase resourceType(@Nullable String resourceType) {
  ...
  public StatusUpdateBase title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public StatusUpdateBase resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public StatusUpdateBase htmlText(@Nullable String htmlText) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, title, resourceSubtype, text, htmlText, statusType);
  }
