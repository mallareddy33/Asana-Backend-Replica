...
public interface EnumOptionsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_UPDATE_ENUM_OPTION = "/enum_options/{enum_option_gid}";
    /**
     ...
     * @param updateEnumOptionRequest The enum option object to update (optional)
     * @return Successfully updated the specified custom field enum. (status code 200)
    ...
    @Operation(
        ...
        description = "<b>Required scope: </b><code>custom_fields:write</code>  Updates an existing enum option. Enum custom fields require at least one enabled enum option. Locked custom fields can only be updated by the user who locked the field. Returns the full record of the updated enum option.",
        tags = { "Custom fields" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successfully updated the specified custom field enum.", content = {
    ...
    @RequestMapping(
        ...
        value = EnumOptionsApi.PATH_UPDATE_ENUM_OPTION,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<CreateEnumOptionForCustomField201Response> updateEnumOption(
        @NotNull @Parameter(name = "enum_option_gid", description = "Globally unique identifier for the enum option.", required = true, in = ParameterIn.PATH) @PathVariable("enum_option_gid") String enumOptionGid,
        ...
        @Parameter(name = "UpdateEnumOptionRequest", description = "The enum option object to update") @Valid @RequestBody(required = false) @Nullable UpdateEnumOptionRequest updateEnumOptionRequest
    ) {
