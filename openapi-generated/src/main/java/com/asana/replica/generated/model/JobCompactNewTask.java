...
@JsonTypeName("JobCompact_new_task")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.17.0")
public class JobCompactNewTask {
  ...
  public JobCompactNewTask gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public JobCompactNewTask resourceType(@Nullable String resourceType) {
  ...
  public JobCompactNewTask name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public JobCompactNewTask resourceSubtype(@Nullable ResourceSubtypeEnum resourceSubtype) {
  ...
  public JobCompactNewTask createdBy(@Nullable TaskCompactCreatedBy createdBy) {
  ...
  public boolean equals(Object o) {
    ...
    JobCompactNewTask jobCompactNewTask = (JobCompactNewTask) o;
    return Objects.equals(this.gid, jobCompactNewTask.gid) &&
        Objects.equals(this.resourceType, jobCompactNewTask.resourceType) &&
        Objects.equals(this.name, jobCompactNewTask.name) &&
        Objects.equals(this.resourceSubtype, jobCompactNewTask.resourceSubtype) &&
        Objects.equals(this.createdBy, jobCompactNewTask.createdBy);
  }
