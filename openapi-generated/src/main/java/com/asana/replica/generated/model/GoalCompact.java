...
@Schema(name = "GoalCompact", description = "A generic Asana Resource, containing a globally unique identifier.")
...
public class GoalCompact {
  ...
  public GoalCompact gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public GoalCompact resourceType(@Nullable String resourceType) {
  ...
  public GoalCompact name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GoalCompact owner(@Nullable GoalCompactOwner owner) {
    this.owner = owner;
    return this;
  }
