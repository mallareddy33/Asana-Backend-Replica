...
@Schema(name = "RateCompact", description = "A *rate* is a monetary value assigned to a resource - `user` or `placeholder` - for a given `parent` object.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.17.0")
public class RateCompact {
  ...
  public RateCompact gid(@Nullable String gid) {
    this.gid = gid;
    return this;
  }
  ...
  public RateCompact resourceType(@Nullable String resourceType) {
  ...
  public RateCompact parent(@Nullable ProjectCompact parent) {
    this.parent = parent;
    return this;
  }
  ...
  public RateCompact resource(@Nullable UserCompact resource) {
  ...
  public RateCompact rate(@Nullable BigDecimal rate) {
    this.rate = rate;
    return this;
  }
  ...
  public RateCompact currencyCode(@Nullable String currencyCode) {
  ...
  public RateCompact createdBy(@Nullable UserCompact createdBy) {
  ...
  public boolean equals(Object o) {
    ...
    RateCompact rateCompact = (RateCompact) o;
    return Objects.equals(this.gid, rateCompact.gid) &&
        Objects.equals(this.resourceType, rateCompact.resourceType) &&
        Objects.equals(this.parent, rateCompact.parent) &&
        Objects.equals(this.resource, rateCompact.resource) &&
        Objects.equals(this.rate, rateCompact.rate) &&
        Objects.equals(this.currencyCode, rateCompact.currencyCode) &&
        Objects.equals(this.createdBy, rateCompact.createdBy);
  }
